...
Public Class Buscarproducto
    ...
    Private Sub BuscarProductos()
        ...
        If TextBox2.TextLength > 0 Or TextBox1.TextLength > 0 Then
            Dim consulta As String = "SELECT * FROM productos WHERE id = @id OR nombre = @nombre"
            ...
            End Try
        Else
            MessageBox.Show("Por favor, ingresa un ID para borrar un producto o el nombre")
        End If
    End Sub
    Private Sub BorrarProductos()
        ...
        If TextBox2.TextLength > 0 Or TextBox1.TextLength > 0 Then
            Dim nombre = TextBox2.Text
            Dim consulta As String = "DELETE FROM productos WHERE id = @id OR nombre = @nombre"
            Dim comando As New SqlCommand(consulta, conexion)
            ...
            Catch ex As Exception
                MessageBox.Show("Error al borrar el producto: " & ex.Message)
